...
public class ArtificialIntelligence {
    ...
    private List<Robot> choseRobots() {
        ...
        while( robots.size() != 5 ) {
            switch( Constants.random.nextInt( 3 ) ) {
                case 0:
                    robots.add( new Tank( this.view,
                        new Team( this.axisBase, this.view.getPlateau(), this.team ) ) );
                    break;
                case 1:
                    robots.add( new Scavenger( this.view,
                        new Team( this.axisBase, this.view.getPlateau(), this.team ) ) );
                    break;
                case 2:
                    robots.add( new Shooter( this.view,
                        new Team( this.axisBase, this.view.getPlateau(), this.team ) ) );
                    break;
            }
        }
    ...
    private String choseNomPays() {
        return Constants.NAME_COUNTRY[ Constants.random
            .nextInt( Constants.NAME_COUNTRY.length - 1 ) ];
    }
