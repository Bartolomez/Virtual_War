    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (Input.readInt("Votre choix : ", 1, 3) - 1) {
            ...
            case 0:
                ...
                do {
                    ...
                    if (sameCountry(ia[0].getNomPays(), ia[1].getNomPays())) {
                        ShowFrame.showErr(
                                "Vous devez choisir un pays different de la première IA !");
                    }
            ...
            case 1:
                ...
                switch (Input.readInt("Votre choix : ", 1, 2) - 1) {
                    ...
                    case 1:
                        ...
                        team[1] = new ArtificialIntelligence(
                                new Axis(plateau.getLength() - 1, plateau.getWidth() - 1), plateau,
                                2, team[1].getNomPays());
                        break;
                }
                ...
                do {
                    ...
                    if (teamCourante.isIa()) {
                        System.out.printf("[Tour " + count + "] " + teamCourante.getNomPays()
                                + " à joué :\n");
                    } else {
                        System.out.printf("[Tour " + count + "]\n" + teamCourante.getView()
                                .getPlateau() + "\n" + teamCourante.getNomPays()
                                + " c'est à votre tour ! \n");
                    }
            ...
            case 2:
                ...
                count = 0;
                do {
                    System.out.printf("[ Tour " + count + "]\n" + teams[count % 2].getView()
                            .getPlateau() + "\n" + teams[count % 2].getNomPays()
                            + " c'est à votre tour ! \n");
